...
const struct ClassData ClassLanceArmorM = {
        .nameTextId = MSG_CLASS_LANCE_ARMOUR_NAME,
        .descTextId = MSG_CLASS_LANCE_ARMOUR_DESC,
        .number = CLASS_LANCE_ARMOR_M,
        .promotion = CLASS_GENERAL,
        .SMSId = CLASS_LANCE_ARMOR_M - 1,
