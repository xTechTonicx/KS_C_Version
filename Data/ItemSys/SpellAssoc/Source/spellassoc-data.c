...
// TODO Delete unnecessary clutter

const struct SpellAssoc gSpellAssocData_Rework[] = {
	SPELL_ASSOC_DATA_WPN_DEFAULT(ITEM_SWORD_BRONZE),
	...
	SPELL_ASSOC_DATA_WPN_DEFAULT(ITEM_LANCE_BRONZE),
	...
	SPELL_ASSOC_DATA_WPN(ITEM_LANCE_SPEAR, 3),

	SPELL_ASSOC_DATA_WPN_DEFAULT(ITEM_AXE_BRONZE),
	...
	SPELL_ASSOC_DATA_WPN(ITEM_AXE_HANDAXE, 3),
	SPELL_ASSOC_DATA_WPN(ITEM_AXE_TOMAHAWK, 3),

	SPELL_ASSOC_DATA_WPN(ITEM_BOW_BRONZE, 2),
	...
	SPELL_ASSOC_DATA_WPN_MAGIC(ITEM_LIGHT_LIGHTNING, 0x1F,
	...
	SPELL_ASSOC_DATA(ITEM_STAFF_HEAL, 2, 0x26, ProcScr_SpellAssocHeal, true,
			 MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_MEND, 2, 0x27, ProcScr_SpellAssocMend, true,
			 MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_RECOVER, 2, 0x28, ProcScr_SpellAssocRecover,
			 true, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_PHYSIC, 2, 0x29, ProcScr_SpellAssocPhysic,
			 true, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_FORTIFY, 1, 0x2A, ProcScr_SpellAssocLatona,
			 false, MA_FACING_DEFAULT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_WARP, 2, -2, ProcScr_SpellAssocWarp, false,
			 MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_RESCUE, 2, -2, ProcScr_SpellAssocWarp,
			 false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_RESTORE, 2, 0x2C, ProcScr_SpellAssocRestore,
			 false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_SILENCE, 2, 0x2D, ProcScr_SpellAssocSilence,
			 false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_SLEEP, 2, 0x2E, ProcScr_SpellAssocSleep,
			 false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_TORCH, 1, -2, ProcScr_SpellAssocTorch,
			 false, MA_FACING_DEFAULT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_REPAIR, 2, 0x2F, ProcScr_SpellAssocRepair,
			 false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_BERSERK, 2, 0x30, ProcScr_SpellAssocBerserk,
			 false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_UNLOCK, 1, -2, ProcScr_SpellAssocUnlock,
			 false, MA_FACING_UNK, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_BARRIER, 2, 0x31, ProcScr_SpellAssocBarrier,
			 false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	...
	SPELL_ASSOC_DATA(ITEM_VULNERARY, 1, -2, ProcScr_SpellAssocVulenrary,
			 true, MA_FACING_DEFAULT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_VULNERARY_2, 1, -2, ProcScr_SpellAssocVulenrary,
			 true, MA_FACING_DEFAULT, SPELL_ASSOC_MCOLOR_NORMAL),
