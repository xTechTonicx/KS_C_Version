...
{
	return _GetSkillIconExt(sid, Skill_INFO_GENERIC);
}
const u8 *GetSkillIcon2(const u8 sid)
{
	return _GetSkillIconExt(sid, Skill_INFO_PERSON);
}
const u8 *GetSkillIcon3(const u8 sid)
{
	return _GetSkillIconExt(sid, Skill_INFO_JOB);
}
const u8 *GetSkillIcon4(const u8 sid)
{
	return _GetSkillIconExt(sid, Skill_INFO_ITEM);
}
